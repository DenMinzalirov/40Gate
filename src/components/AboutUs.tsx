...
const AboutUs = () => {
    ...
    return (
        <section id="about-us" className="w-full pt-[120px] xl:pt-[200px] px-5 xl:px-10">
            <div className="w-full max-w-[1440px] mx-auto">
                <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-[100px]">
                    ...
                    <div className="flex justify-between items-end self-stretch flex-grow-0 flex-shrink-0 relative">
                        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-full xl:w-[925px] gap-[30px]">
                            <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-3">
                                ...
                                <p className="flex-grow-0 flex-shrink-0 text-xl xl:text-2xl text-left text-[#1e1e1e]">
                                    About us
                                </p>
                            </div>
                            <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-3.5">
                                <p className="flex-grow-0 flex-shrink-0 w-full xl:w-[905.6px] text-3xl xl:text-[55px] text-left text-[#1e1e1e] font-tinos">
                        ...
                        <p className="hidden xl:block flex-grow-0 flex-shrink-0 text-3xl xl:text-[55px] text-left text-[#0008D4] font-tinos">
                            (04)
                        </p>
                    </div>

                    {/* Статистика */}
                    <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-[30px] xl:gap-[85px]">
                        {/* Первая статистика - 1000+ */}
                        <div className="flex flex-wrap justify-between items-end w-full flex-col xl:flex-row items-start xl:items-end">
                            <div ref={number1Ref} className="h-[180px] text-[120px] xl:text-[261.7px] text-left text-[#0008D4] font-tinos leading-none flex items-center">
                                1000+
                            </div>
                            <div className="h-[92px] min-w-[335px] hidden xl:block">
                            ...
                            <div className="min-w-[335px] block xl:hidden text-xl">Merchants already with us</div>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-between items-end w-full flex-col xl:flex-row items-start xl:items-end">
                            <div ref={number2Ref} className="h-[180px] text-[120px] xl:text-[261.7px] text-left text-[#0008D4] font-tinos leading-none flex items-center">
                                300+
                            </div>
                            <div className="h-[92px] min-w-[335px] hidden xl:block">
                                <div className="flex flex-row justify-start items-center">
                            ...
                            <div className="min-w-[335px] block xl:hidden text-xl">Any fiat & crypto</div>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-between items-end w-full flex-col xl:flex-row items-start xl:items-end">
                            <div ref={number3Ref} className="h-[180px] text-[120px] xl:text-[261.7px] text-left text-[#0008D4] font-tinos leading-none flex items-center">
                                30+
                            </div>
                            <div className="h-[92px] min-w-[335px] hidden xl:block">
                                <div className="flex flex-row justify-start items-center">
                            ...
                            <div className="min-w-[335px] block xl:hidden text-xl">Available payment methods</div>
                        </div>
                    </div>
                </div>
            </div>
